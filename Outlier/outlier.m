...
locations=data(53).export(x_index,y_index).locations;
...
epsilon=cell_out(1).epsilon; % min distance between points in meters
MinPts=2%cell_out(1).minPts; %min size of the cluster
